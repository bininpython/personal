...
export default function TermsPage() {
  return <main className="min-h-screen bg-background px-4 py-12"><article className="mx-auto max-w-3xl space-y-8">
    ...
    <section><h2 className="text-xl font-semibold">2. Conta e códigos</h2><p className="mt-3 leading-relaxed text-muted-foreground">O nome e os códigos identificam a conta. Código secreto e chave de recuperação são pessoais; o código público do personal pode ser compartilhado com alunos. O usuário deve trocar códigos diante de suspeita de acesso indevido.</p></section>
