...
const sections = [
  ['1. Aceite e escopo', 'Ao criar uma conta ou continuar após o primeiro acesso, você aceita estes Termos. A D KONG oferece ferramentas para organizar alunos, fichas, execuções, avaliações, agenda, mensagens e indicadores de acompanhamento. O serviço não substitui avaliação médica, atendimento de emergência nem a decisão técnica de um profissional habilitado.'],
  ...
  ['7. Disponibilidade e alterações', 'A D KONG busca manter o serviço disponível e seguro, mas pode realizar manutenção, corrigir falhas ou alterar funcionalidades. Interrupções e perda de disponibilidade podem ocorrer. Mudanças relevantes destes Termos serão informadas no serviço, com nova solicitação de aceite quando necessário.'],
  ['8. Planos, cancelamento e encerramento', 'Não há cobrança automática dentro da versão atual do serviço. Qualquer oferta futura paga deverá apresentar preço, periodicidade, renovação e cancelamento antes da contratação. O usuário pode excluir sua conta pelos controles integrados. A D KONG pode suspender uso abusivo ou ilegal, preservados os direitos aplicáveis.'],
  ['9. Limites e legislação', 'Na extensão permitida pela lei, a D KONG não responde por decisões profissionais, uso fora da finalidade, falhas causadas por terceiros ou eventos inevitáveis. Estes Termos seguem a legislação brasileira, inclusive normas de consumo e proteção de dados; permanece assegurado o foro legalmente competente do usuário.'],
...
export default function TermsPage() {
  return <main className="min-h-screen bg-background px-4 py-12"><article className="mx-auto max-w-3xl space-y-8">
    ...
    <p className="rounded-lg border bg-muted/20 p-4 leading-relaxed text-muted-foreground">Estes Termos regulam o uso da plataforma D KONG por personal trainers e alunos.</p>
