...
const sections = [
  ...
  ['Segurança e fotos', 'Códigos secretos são armazenados em formato irreversível. Sessões podem ser revogadas e tentativas abusivas são bloqueadas. Fotos enviadas ficam em armazenamento privado e são entregues somente por rota autenticada; a foto anterior é removida quando substituída.'],
