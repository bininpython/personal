...
const sections = [
  ...
  ['Responsabilidades', 'O personal é responsável pela legitimidade dos dados que cadastra de seus alunos e por mantê-los corretos. A D KONG deve manter medidas técnicas e administrativas adequadas e comunicar incidentes quando exigido.'],
];
...
export default function PrivacyPage() {
  return <main className="min-h-screen bg-background px-4 py-12"><article className="mx-auto max-w-3xl space-y-8">
    ...
    <p className="rounded-lg border bg-muted/20 p-4 leading-relaxed text-muted-foreground">Esta política explica de forma clara como a D KONG trata dados. Ela deve ser revisada por assessoria jurídica antes da operação comercial e adaptada com a identificação e o canal oficial do controlador.</p>
