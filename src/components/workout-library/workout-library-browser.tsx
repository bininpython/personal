        ...
        <div className="relative grid gap-8 lg:grid-cols-[1fr_auto] lg:items-center">
          <div className="max-w-3xl">
            ...
            <h2 className="text-2xl font-black tracking-tight sm:text-3xl lg:text-4xl text-white">
              72 fichas completas, 264 rotinas e mais de 1.600 prescrições
            </h2>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-white/70">
              Coleção de programas estruturados (H01 a H25 masculinos e F01 a F25 femininos) com fotos locais,
          ...
          <div className="grid grid-cols-3 gap-3 text-center sm:min-w-[340px]">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
              <p className="text-2xl font-black text-[#38bdf8]">37</p>
              <p className="text-[10px] uppercase font-bold tracking-wider text-white/60">Homens</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 backdrop-blur-sm">
              <p className="text-2xl font-black text-[#f472b6]">35</p>
